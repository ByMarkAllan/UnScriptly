 ...
 */
var HTML_STUDIO_BUILD = '8.12.0-github-drive-media-preview-20260830';
...
function htmlStudioArchiveProjectImage(projectId, request) {
  ...
  try {
    ...
    var response = UrlFetchApp.fetch(sourceUrl, {
      ...
      headers: { 'User-Agent': 'UnScriptly-HTML-Studio/8.12.0' }
    });
...
/* Drive Media Library server functions were moved to StudioMediaServer.gs. */
